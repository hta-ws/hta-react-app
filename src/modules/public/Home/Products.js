...
import { productData } from './LandingNFT';
const Products = () => {
            ...
            <Col lg={8}>
              <div className='text-center mb-5'>
                <h2 className='mb-3 fw-semibold lh-base'>
                  Analiz Araçlarını Keşfedin
                </h2>
                <p className='text-muted mb-4'>
                  Finansal analiz araçlarımız, piyasadaki hisse senetlerini,
                  bilanço verilerini ve sektörel raporları derinlemesine
                  incelemenize olanak tanır. Her araç, yatırım kararlarınızı
                  bilgiye dayalı olarak şekillendirmenizi sağlar.
                </p>
