...
const FormView3 = ({ updateApiData }) => {
  ...
  const actionGet = 'get-report-calculation-code'; // Default action for GET
          ...
          >
            {({ isSubmitting, setFieldValue, values }) => (
              <Form>
                ...
                <SpSelectInput
                  name='financial_statement_procedure'
                  label='Financial Statement Procedure'
                  onChange={setFieldValue}
                  value={values.sp_id}
                  disabled={formData?.is_locked != 1} // Passing disabled as a prop
                />
                <div className='mb-3'>
