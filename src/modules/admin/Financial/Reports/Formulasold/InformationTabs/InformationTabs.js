...
import FormulaView from '../FormView/components/FormulaView';
    ...
    <>
      <Nav tabs>
        ...
        <NavItem>
          ...
          >
            Hesaplama Örnek sonucları
          </NavLink>
        </NavItem>
      </Nav>
      <TabContent activeTab={activeTab}>
        <TabPane tabId='1'>
          <FormulaView formikValues={formData} />
        </TabPane>
        <TabPane tabId='2'>
          <RunLog formikValues={formData} />
        </TabPane>
