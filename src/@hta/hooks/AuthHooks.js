// ForJWT Auth
import { getUserFromJwtAuth } from '@hta/helpers/AuthHelper';
import {
  useJWTAuth,
  useJWTAuthActions,
} from '@hta/services/auth/jwt-auth/JWTAuthProvider';
...
//   useFirebase,
//   useFirebaseActions,
// } from '@veo/services/auth/firebase/FirebaseAuthProvider';
// import { getUserFromFirebase } from '@veo/helpers/AuthHelper';
...
/*
// For AWS Auth
import { getUserFromAWS } from '@veo/helpers/AuthHelper';
import {
  useAwsCognito,
  useAwsCognitoActions,
} from '@veo/services/auth/AWSAuthProvider';
...
import { getUserFromAuth0 } from '@veo/helpers/AuthHelper';
