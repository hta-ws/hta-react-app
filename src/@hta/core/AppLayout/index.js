...
import AppContentView from '@hta/core/AppLayout/AppContentView';
import generateRoutes from '@hta/helpers/RouteGenerator';
...
const AppLayout = () => {
  ...
  return (
    <>
      {isAuthenticated ? (
        <>
          <AppHeader headerClass='topbar-shadow' />
          <AppSidebar />
          <AppContentView
